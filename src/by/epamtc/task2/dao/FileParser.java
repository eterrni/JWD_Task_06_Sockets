...
public class FileParser {
    ...
    public static final String REGEX_PARAGRAPH_NUMBER;
    ...
    static {
        ...
        REGEX_DELIMITER_SENTENCES = instance.getProperty("regex.sentence");
        REGEX_DELIMITER_SENTENCE_PARTS = instance.getProperty("regex.part");
        REGEX_WORD = instance.getProperty("regex.word");
        REGEX_PARAGRAPH_NUMBER = instance.getProperty("regex.paragraph");
    }
